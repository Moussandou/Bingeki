...
import AdminSocialMockup from '@/components/mockups/AdminSocialMockup';
    ...
    return (
        <div style={{ padding: '40px', background: '#f5f5f5', minHeight: '100vh', color: '#000' }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                ...
                {/* SECTION: SOCIAL BOT — INSTAGRAM POSTS */}
                <section style={{ marginBottom: '4rem' }}>
                    <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '1rem', borderBottom: '2px solid #000', paddingBottom: '0.5rem' }}>Social Bot — Instagram Feed Posts</h2>
                    <div style={{ border: '3px solid #000', boxShadow: '8px 8px 0 #000', overflow: 'hidden' }}>
                        <SocialPostMockup />
                    </div>
                </section>

                {/* SECTION: SOCIAL BOT — ADMIN PANEL */}
                <section style={{ marginBottom: '4rem' }}>
                    <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '1rem', borderBottom: '2px solid #000', paddingBottom: '0.5rem' }}>Social Bot — Admin Panel (validation posts)</h2>
                    <AdminSocialMockup />
                </section>
