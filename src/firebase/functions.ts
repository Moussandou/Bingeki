...
export const getRandomMangaFn       = httpsCallable<{ nsfwMode?: boolean }, unknown>(functions, 'getRandomManga');
export const getGenresFn            = httpsCallable<{ type: string }, unknown>(functions, 'getGenres');
export const getProducersFn         = httpsCallable<{ limit?: number; page?: number; query?: string }, unknown>(functions, 'getProducers');
export const getSeasonsListFn       = httpsCallable<Record<string, never>, unknown>(functions, 'getSeasonsList');
export const getUpcomingAnimeFn     = httpsCallable<{ limit?: number; nsfwMode?: boolean }, unknown>(functions, 'getUpcomingAnime');
export const getSeasonAnimeFn       = httpsCallable<{ year: number; season: string; limit?: number; page?: number; nsfwMode?: boolean }, unknown>(functions, 'getSeasonAnime');
export const getRecentRecommendationsFn = httpsCallable<{ type?: string; limit?: number; nsfwMode?: boolean }, unknown>(functions, 'getRecentRecommendations');
export const getTopCharactersFn     = httpsCallable<{ limit?: number; page?: number }, unknown>(functions, 'getTopCharacters');
export const getWorkNewsFn          = httpsCallable<{ id: number; type: string }, unknown>(functions, 'getWorkNews');
